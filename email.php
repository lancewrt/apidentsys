                 ...
                 <tr>
                  <td valign="top" align="center" style="padding:0;Margin:0;width:560px">
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px;text-transform: capitalize;">Dear <?php echo "$recipientFname $recipientLname";?>,</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px">This email is to confirm your upcoming appointment at Toothie Cutie Dental Clinic on <?php echo $apptDate.' from '.$apptTime?></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px">Appointment details:</p>
                       <ul style="font-family:arial, 'helvetica neue', helvetica, sans-serif;padding:0px 0px 0px 40px;margin-top:15px;margin-bottom:15px;list-style-type:circle">
                        <li style="color:#31A3B9;margin:0px 0px 15px;font-size:14px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px;mso-margin-top-alt:15px">Date: <?php echo $apptDate?></p></li>
                        <li style="color:#31A3B9;margin:0px 0px 15px;font-size:14px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px">Time: <?php echo $apptTime?></p></li>
                        <li style="color:#31A3B9;margin:0px 0px 15px;font-size:14px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif"><p style="Margin:0;mso-line-height-rule:exactly;mso-margin-bottom-alt:15px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px">Location: Cristina Ave, Las Pinas, 1740 Metro Manila</p></li>
                       </ul><p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px">Please arrive at least <strong>15 minutes</strong> early to confirm your appointment.</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px">We look forward to seeing you!</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#31a3b9;font-size:14px">Take note that you cannot reschedule an existing appointment. To book a new time slot, you'll need to <u><strong>cancel</strong></u> this appointment first.</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#31a3b9;font-size:14px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#31a3b9;font-size:14px">If you need to cancel your appointment, please click the button below:</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
               ...
               <table width="100%" cellpadding="0" cellspacing="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0"><span class="es-button-border es-il" style="border-style:solid;border-color:#2CB543;background:#B93131;border-width:0px 0px 2px 0px;display:inline-block;border-radius:10px;width:auto"><a href="https://apidentsys.tuplrc-cla.com/appointment-cancelled/<?php echo $apptId?>" target="_self" class="es-button es-button-1121" style="mso-style-priority:100 !important;text-decoration:none !important;mso-line-height-rule:exactly;color:#FFFFFF;font-size:14px;padding:10px 20px 10px 20px;display:inline-block;background:#B93131;border-radius:10px;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;font-weight:normal;font-style:normal;line-height:16.8px;width:auto;text-align:center;letter-spacing:0;mso-padding-alt:0;mso-border-alt:10px solid #B93131">Cancel this appointment</a></span></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
               ...
               <table cellspacing="0" cellpadding="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                 <tr>
                  <td valign="top" align="center" style="padding:0;Margin:0;width:560px">
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#31A3B9;font-size:14px">If you have any questions or need further assistance, please contact us at <strong style="color:#2cb543">0912345678</strong> or <strong style="color:#2cb543">toothiecutie@gmail.com</strong></p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table width="100%" role="presentation" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <!-- papalitan na lang ng filename tnx pu-->
                      <td align="center" style="padding:0;Margin:0;padding-bottom:10px;padding-top:45px;font-size:0"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlp2jp7OnZGWozg8VnNmQkwIHW-oXzClho1w&s" alt="Toothie Cutie Dental Clinic logo" width="50" class="img-2701" style="display:block;font-size:14px;border:0;outline:none;text-decoration:none"></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:600px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:20px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:21px;letter-spacing:0;color:#2cb543;font-size:14px"><b>© Toothie Cutie Dental Clinic</b></p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
